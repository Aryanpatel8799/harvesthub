              ...
              <TableBody>
                {orders.map((order) => (
                  <TableRow key={order._id}>
                    ...
                    <TableCell>{order.quantity} {order.product?.unit || 'units'}</TableCell>
                    <TableCell>₹{order.totalPrice?.toFixed(2) || '0.00'}</TableCell>
                    <TableCell>{order.consumerDetails?.fullName || 'Unknown'}</TableCell>
            ...
            <div className="space-y-4">
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <p>Name: {selectedOrder.consumerDetails?.fullName || 'Unknown'}</p>
                  <p>Phone: {selectedOrder.consumerDetails?.phone || 'N/A'}</p>
                  <p>Address: {selectedOrder.consumerDetails?.address || 'N/A'}</p>
